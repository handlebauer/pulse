    ...
    public: {
        Tables: {
            ...
            station_topics: {
                ...
                Relationships: [
                    {
                        foreignKeyName: 'station_topics_stationId_fkey'
                        columns: ['stationId']
                        isOneToOne: false
                    ...
                    {
                        foreignKeyName: 'station_topics_topicId_fkey'
                        columns: ['topicId']
                        isOneToOne: false
            ...
            topic_connections: {
                ...
                Relationships: [
                    {
                        foreignKeyName: 'topic_connections_stationId1_fkey'
                        columns: ['stationId1']
                        isOneToOne: false
                        referencedRelation: 'stations'
                        referencedColumns: ['id']
                    ...
                    {
                        foreignKeyName: 'topic_connections_stationId2_fkey'
                        columns: ['stationId2']
                        isOneToOne: false
                        referencedRelation: 'stations'
                        referencedColumns: ['id']
                    ...
                    {
                        foreignKeyName: 'topic_connections_topicId_fkey'
                        columns: ['topicId']
                        isOneToOne: false
                        referencedRelation: 'topics'
                        referencedColumns: ['id']
